...
create table "reservation-quota" ("event_id" BIGINT NOT NULL,"member_id" BIGINT NOT NULL,"quota" INTEGER NOT NULL);
alter table "reservation-quota" add constraint "event-member_pkey" primary key("event_id","member_id");
create table "show-prereservations" ("show_id" BIGINT NOT NULL,"member_id" BIGINT NOT NULL,"quantity" INTEGER NOT NULL);
alter table "show-prereservations" add constraint "show-member_pkey" primary key("show_id","member_id");
...
alter table "reservation-quota" add constraint "member_fk" foreign key("member_id") references "member"("id") on update NO ACTION on delete NO ACTION;
...
alter table "show-prereservations" add constraint "member_fk" foreign key("member_id") references "member"("id") on update NO ACTION on delete NO ACTION;
...
alter table "reservation-quota" drop constraint "member_fk";
alter table "show-prereservations" drop constraint "show_fk";
alter table "show-prereservations" drop constraint "member_fk";
...
drop table "member";
drop table "order";
alter table "reservation-quota" drop constraint "event-member_pkey";
drop table "reservation-quota";
alter table "show-prereservations" drop constraint "show-member_pkey";
