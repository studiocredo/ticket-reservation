...
alter table "user" add constraint "login-group_fk" foreign key("login-group_id") references "user"("id") on update NO ACTION on delete NO ACTION;
...
alter table "user" drop constraint "login-group_fk";
