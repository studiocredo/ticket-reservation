...
val order = Order(OrderId(655L), user.id, DateTime.now(), "Test Naam", "Teststraat 99\n8000 Brugge", processed = false, archived = false, Some("Automatisch aangemaakt door test script"))
